  ...
  useEffect(() => {
      ...
      roadBlocks.forEach(block => {
        ...
        const iconHtml = `
          <div class="relative group cursor-pointer">
            <div class="w-12 h-12 rounded-full ${severityColor} border-4 border-white flex items-center justify-center shadow-xl animate-pulse">
    ...
    if (showStations) {
      stations.forEach(station => {
        ...
        const iconHtml = `
          <div class="relative group cursor-pointer">
            <div class="w-10 h-10 rounded-full ${isAvailable ? 'bg-green-500' : 'bg-gray-400'} border-3 border-white flex items-center justify-center shadow-xl transform transition-all hover:scale-110 ${isAvailable ? 'animate-pulse' : ''}">
    ...
    if (showReports) {
      reports.forEach(report => {
        ...
        // Define border color based on severity
        ...
        const iconHtml = `
          <div class="relative group cursor-pointer">
            <div class="w-10 h-10 rounded-full bg-white border-4 ${borderColorClass} flex items-center justify-center shadow-md overflow-hidden ${report.severity === 'DANGER' ? 'animate-pulse' : ''}">
